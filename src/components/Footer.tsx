        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/40 text-sm leading-relaxed mb-8 max-w-xs">
              Delivering reliable electrical engineering and power solutions for
              commercial, industrial, and residential projects across Rwanda and
              East Africa.
            </p>
            {/* Social links */}
          ...
          {/* Quick links */}
          <div>
            <h3 className="text-white text-sm uppercase tracking-[0.15em] mb-6">
              Quick Links
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <svg
                  className="w-4 h-4 text-[#F07C21] mt-0.5 flex-shrink-0"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="1.5"
              ...
              <li>
                ...
                >
                  ...
                  <span className="text-white/40 text-sm group-hover:text-[#F07C21] transition-colors duration-300">
                    +250 780 000 000
                  </span>
                </a>
              </li>
              <li>
                <a
                  href="mailto:info@powerplustech.rw"
                  className="flex items-start gap-3 group"
                >
                  <svg
                    className="w-4 h-4 text-[#F07C21] mt-0.5 flex-shrink-0"
